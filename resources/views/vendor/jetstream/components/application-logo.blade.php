<svg class="w-12" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" {{ $attributes }}>
  ...
  <defs>
    ...
    <filter id="filter2_i_38_6" x="126.667" y="143.333" width="146.667" height="117.333" filterUnits="userSpaceOnUse"
      color-interpolation-filters="sRGB">
      <feFlood flood-opacity="0" result="BackgroundImageFix" />
